...
module ComputerTools
  module Actions
    ...
    #   ComputerTools::Actions::BlueprintListAction.new.call
    #
    ...
    class BlueprintListAction < Sublayer::Actions::Base
      ##
      # Initializes a new BlueprintListAction instance.
      #
      ...
      # @return [BlueprintListAction] a new instance of BlueprintListAction
      ...
      #   action = ComputerTools::Actions::BlueprintListAction.new
      #   action.call #=> true
      def call
