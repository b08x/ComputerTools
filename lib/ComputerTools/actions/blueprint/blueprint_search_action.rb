...
module ComputerTools
  module Actions
    ##
    # BlueprintSearchAction provides search functionality for blueprints in the system.
    ...
    #   action = BlueprintSearchAction.new(query: "user authentication")
    #   action.call
    #
    # @example Text search with custom limit
    #   action = BlueprintSearchAction.new(query: "database connection", semantic: false, limit: 5)
    #   action.call
    class BlueprintSearchAction < Sublayer::Actions::Base
      ##
      # Initializes a new BlueprintSearchAction with search parameters.
      #
      ...
      # @return [BlueprintSearchAction] A new instance of BlueprintSearchAction
