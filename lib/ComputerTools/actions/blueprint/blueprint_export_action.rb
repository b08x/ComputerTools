...
module ComputerTools
  module Actions
    ##
    # BlueprintExportAction handles the export of blueprints from the database to files.
    #
    ...
    #
    # Example:
    #   action = ComputerTools::Actions::BlueprintExportAction.new(id: 123, include_metadata: true)
    #   action.call
    class BlueprintExportAction < Sublayer::Actions::Base
      ##
      # Initializes a new BlueprintExportAction.
      #
      ...
      # @return [BlueprintExportAction] a new instance of BlueprintExportAction
      #
      # @example Exporting a blueprint with metadata
      #   action = ComputerTools::Actions::BlueprintExportAction.new(
      #     id: 123,
      ...
      #   action = ComputerTools::Actions::BlueprintExportAction.new(id: 123)
      #   action.call #=> true
      def call
