...
module ComputerTools
  module Generators
    ...
    #   generator = ComputerTools::Generators::BlueprintCategoryGenerator.new(code: code_snippet, description: description)
    ...
    class BlueprintCategoryGenerator < Sublayer::Generators::Base
      ...
      # Initializes a new BlueprintCategoryGenerator instance.
      #
