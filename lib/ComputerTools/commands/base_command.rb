...
module ComputerTools
  module Commands
    ##
    # BaseCommand serves as the abstract foundation for all command classes in ComputerTools.
    ...
    class BaseCommand
      ...
      # @example For a class named ComputerTools::Commands::InstallCommand
      ...
      ##
      # Provides access to the ComputerTools logger instance.
      #
