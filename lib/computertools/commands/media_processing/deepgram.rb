...
module ComputerTools
  module Commands
    module MediaProcessing
      ...
      #
      # @see ComputerTools::Actions::DeepgramParse
      # @see ComputerTools::Actions::DeepgramAnalyze
      # @see ComputerTools::Actions::DeepgramConvert
      # @see ComputerTools::Actions::DeepgramConfig
      class Deepgram < Interface::Base
      ...
      #
      # Sets up the command with an initial set of options inherited from `Interface::Base`.
      ...
      def handle_parse
        ...
        ComputerTools::Actions::DeepgramParse.new(
          json_file: json_file,
      ...
      #
      # @return [Object, Boolean] The result of the `DeepgramAnalyze.call` method
      ...
      def handle_analyze
        ...
        ComputerTools::Actions::DeepgramAnalyze.new(
          json_file: json_file,
      ...
      # {ComputerTools::Actions::DeepgramConvert}.
      #
      # @return [Object, Boolean] The result of the `DeepgramConvert.call` method
      ...
      def handle_convert
        ...
        ComputerTools::Actions::DeepgramConvert.new(
          json_file: json_file,
      ...
      # {ComputerTools::Actions::DeepgramConfig}.
      #
      # @return [Object] The result of the `DeepgramConfig.call` method,
      #   which typically indicates the success or outcome of the configuration operation.
      # @see ComputerTools::Actions::DeepgramConfig
      def handle_config
        subcommand = @args.first || 'show'

        ComputerTools::Actions::DeepgramConfig.new(
