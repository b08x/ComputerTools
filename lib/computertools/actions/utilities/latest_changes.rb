...
require 'colorize'
# Action classes are autoloaded by Zeitwerk

module ComputerTools
  module Actions
    module Utilities
      class LatestChanges < Sublayer::Actions::Base
      ...
      def discover_recent_files
        ...
        Actions::Utilities::FileDiscovery.new(
          directory: @directory,
          time_range: @time_range,
          config: @config
        ).call
      ...
      def analyze_files_by_tracking_method(recent_files)
        ...
        unless git_files.empty?
          ...
          git_data = Actions::VersionControl::GitAnalysis.new(
            files: git_files,
            config: @config
          ).call
        ...
        unless yadm_files.empty?
          ...
          yadm_data = Actions::VersionControl::YadmAnalysis.new(
            files: yadm_files,
            config: @config
          ).call
        ...
        unless untracked_files.empty?
          ...
          restic_data = Actions::VersionControl::ResticAnalysis.new(
      ...
      def generate_report(data)
        ...
        ComputerTools::Generators::System::FileActivityReport.new(
          data: data,
          format: @format,
          interactive: @interactive,
          time_range: @time_range,
